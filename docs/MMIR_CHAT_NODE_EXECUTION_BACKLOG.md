...
1. **First chat works without setup**
...
2. **Free model choices are visible and actionable**
...
3. **Local node install feels like a normal app**
...
4. **Install return becomes chat proof automatically**
...
5. **Open WebUI/ChatGPT-level chat polish**
...
Continue `D254`: Mac installer app-bundle/package QA, then deeper Open WebUI-style chat polish.
