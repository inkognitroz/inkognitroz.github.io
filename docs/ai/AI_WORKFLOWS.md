...
## Local model test
Act as a precise local AI assistant. Answer concisely. Focus on implementation steps, risks and next action.

## Productization
Turn this prototype into a launchable v1. Add onboarding, validation, export, backup, mobile polish and clear acceptance criteria.
