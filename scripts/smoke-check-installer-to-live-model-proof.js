...
async function run() {
  ...
  requireTrue(d219?.status === 'next', 'Progress dashboard task D219 must become the next work item after D218 ships.');
  requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D219', 'Progress dashboard next queue must prioritize D219 after D218 ships.');
