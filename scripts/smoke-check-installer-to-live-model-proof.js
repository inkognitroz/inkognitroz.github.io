...
async function run() {
  ...
  requireTrue(d217?.status === 'next', 'Progress dashboard task D217 must become the next work item after D216 ships.');
  requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D217', 'Progress dashboard next queue must prioritize D217 after D216 ships.');
