...
async function run() {
  ...
  requireTrue(d218?.status === 'next', 'Progress dashboard task D218 must become the next work item after D217 ships.');
  requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D218', 'Progress dashboard next queue must prioritize D218 after D217 ships.');
