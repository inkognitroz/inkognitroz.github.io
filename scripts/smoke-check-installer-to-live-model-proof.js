...
async function run() {
  ...
  requireTrue(d216?.status === 'next', 'Progress dashboard task D216 must become the next work item after D215 ships.');
  requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D216', 'Progress dashboard next queue must prioritize D216 after D215 ships.');
