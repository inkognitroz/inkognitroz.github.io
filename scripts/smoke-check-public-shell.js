...
requireText(serviceWorkerPath, 'mmir-pwa-d332-20260601-p0-clean-first-chat-v5', 'Service worker cache must bust for P0 simple chat recovery.');
...
requireText(mmirPath, 'p0-chat-shell.css?v=20260601-p0-clean-first-chat-v5', 'Public page must load the P0 simple chat shell CSS.');
requireText(mmirPath, 'p0-chat-shell.js?v=20260601-p0-clean-first-chat-v5', 'Public page must load the P0 simple chat shell runtime.');
...
requireText(join(publicDir, 'apps', 'mimir-chat-portal', 'p0-chat-shell.js'), "const HISTORY_SCHEMA='20260601-clean-first-chat-v1'", 'P0 shell must invalidate stale browser-error chat history.');
