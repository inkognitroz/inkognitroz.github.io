...
requireText(serviceWorkerPath, 'mmir-pwa-d333-20260602-p0-compare-routes-v11', 'Service worker cache must bust for P0 simple chat recovery.');
...
requireText(mmirPath, 'p0-chat-shell.css?v=20260602-p0-compare-routes-v11', 'Public page must load the P0 simple chat shell CSS.');
requireText(mmirPath, 'p0-chat-shell.js?v=20260602-p0-compare-routes-v11', 'Public page must load the P0 simple chat shell runtime.');
