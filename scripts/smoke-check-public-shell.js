...
requireText(mmirPath, 'active-node-strip.js?v=20260531-supergenius-brand-guard-v1', 'MMIR product page must load the cache-busted active-node strip.');
...
requireText(serviceWorkerPath, 'mmir-pwa-d324-20260531-supergenius-brand-guard-v1', 'Service worker cache must bust for the Supergenius brand guard.');
