...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d298-20260525-startup-free-llm-nodes-v1'", 'Service worker cache must rotate for D296 runtime CSS headroom.');
