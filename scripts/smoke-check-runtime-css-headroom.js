...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d296-20260525-runtime-css-headroom-v1'", 'Service worker cache must rotate for D296 runtime CSS headroom.');
