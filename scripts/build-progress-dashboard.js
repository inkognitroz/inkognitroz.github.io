...
const overrides = new Map([
  ...
  ...range(116, 188).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D188', { status: 'next', evidence: 'Next activation funnel slice: show whether recommended starter selections become install, live proof and first-chat receipts without invasive tracking.' }]
]);
...
const prioritizedNextIds = ['D188', 'D117', 'D116', 'D118', 'D119'];
