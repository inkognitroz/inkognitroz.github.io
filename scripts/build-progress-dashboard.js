...
const overrides = new Map([
  ...
  ['D254', { status: 'next', evidence: 'Chat slice now has public-safe active routes, a free model starter rail and tested WebGPU/local-node handoff. Continue Mac app-bundle/package QA and deeper Open WebUI polish.' }],
