...
const overrides = new Map([
  ...
  ...range(116, 181).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D181', { status: 'next', evidence: 'Next activation QA slice: add a replay render regression harness for every simulator scenario and next-target control.' }]
]);
...
const prioritizedNextIds = ['D181', 'D117', 'D116', 'D118', 'D119'];
