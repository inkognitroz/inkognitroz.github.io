...
const overrides = new Map([
  ...
  ...range(116, 196).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D196', { status: 'next', evidence: 'Next closure slice: successful starter retry should close repair ambiguity and move the user to verified first-chat readiness.' }]
]);
...
const prioritizedNextIds = ['D196', 'D117', 'D116', 'D118', 'D119'];
