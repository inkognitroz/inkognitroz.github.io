...
const overrides = new Map([
  ...
  ...range(116, 155).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D155', { status: 'next', evidence: 'Next platform-readiness slice: account/session and organization identity foundation for real team sharing, marketplace and premium routes.' }]
]);
...
const prioritizedNextIds = ['D155', 'D117', 'D116', 'D118', 'D119'];
