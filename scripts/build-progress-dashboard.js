...
const overrides = new Map([
  ...
  ...range(116, 171).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D171', { status: 'next', evidence: 'Next activation slice: use telemetry to run safe, free automatic repairs before asking users for OS/device steps.' }]
]);
...
const prioritizedNextIds = ['D171', 'D117', 'D116', 'D118', 'D119'];
