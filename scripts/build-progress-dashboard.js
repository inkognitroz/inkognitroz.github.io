...
const overrides = new Map([
  ...
  ...range(116, 192).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D192', { status: 'next', evidence: 'Next model UX slice: focus or highlight the recommended starter inside Model Library when the user follows starter actions.' }]
]);
...
const prioritizedNextIds = ['D192', 'D117', 'D116', 'D118', 'D119'];
