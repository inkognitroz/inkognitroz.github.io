...
const overrides = new Map([
  ...
  ...range(116, 200).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D200', { status: 'next', evidence: 'Next performance slice: recover meaningful critical-shell JS headroom before more first-load UX is added.' }]
]);
...
const prioritizedNextIds = ['D200', 'D117', 'D116', 'D118', 'D119'];
