...
const overrides = new Map([
  ...
  ...range(116, 165).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D165', { status: 'next', evidence: 'Next activation slice: after a route is verified, hand the user into first chat with the verified model selected and fallback guide preserved.' }]
]);
...
const prioritizedNextIds = ['D165', 'D117', 'D116', 'D118', 'D119'];
