...
const overrides = new Map([
  ...
  ...range(116, 187).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D187', { status: 'next', evidence: 'Next activation hardening slice: regain critical-shell byte headroom by moving non-essential first-screen QA banners into deferred hydration.' }]
]);
...
const prioritizedNextIds = ['D187', 'D117', 'D116', 'D118', 'D119'];
