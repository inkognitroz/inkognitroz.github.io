...
const overrides = new Map([
  ...
  ...range(116, 176).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D176', { status: 'next', evidence: 'Next activation slice: show last repair resume result near first screen and Node Dashboard so users see verified/needs-model/needs-action without reading logs.' }]
]);
...
const prioritizedNextIds = ['D176', 'D117', 'D116', 'D118', 'D119'];
