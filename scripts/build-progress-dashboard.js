...
const overrides = new Map([
  ...
  ...range(116, 175).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D175', { status: 'next', evidence: 'Next activation slice: resume the same activation path after a user returns from installer or repair-card links and automatically verify whether repair succeeded.' }]
]);
...
const prioritizedNextIds = ['D175', 'D117', 'D116', 'D118', 'D119'];
