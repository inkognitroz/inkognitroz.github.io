...
const overrides = new Map([
  ...
  ...range(116, 159).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D159', { status: 'next', evidence: 'Next sharing/security slice: guide recipients from invite/session acceptance to the intended protected share with safe denial states and no public token storage.' }]
]);
...
const prioritizedNextIds = ['D159', 'D117', 'D116', 'D118', 'D119'];
