...
const overrides = new Map([
  ...
  ...range(116, 170).map((id) => [id, { status: 'planned', evidence: 'Added to the expanded GUI parity and platform-readiness backlog; implementation has not started.' }]),
  ...
  ['D170', { status: 'next', evidence: 'Next activation slice: show a public-safe activation telemetry timeline for defaults, proof, install, doctor and first chat without raw prompts or secrets.' }]
]);
...
const prioritizedNextIds = ['D170', 'D117', 'D116', 'D118', 'D119'];
