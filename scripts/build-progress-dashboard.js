...
const overrides = new Map([
  ...
  ['D318', { status: 'beta', evidence: 'Automatic first chat now prefers instant MMIR Guide before WebGPU so first value is immediate, while explicit WebGPU LLM routes remain visible and one-click.' }]
]);
...
function buildLaunchProgress() {
  const checkpoints = [
    ...
    {
      id: 'local-node-ready-status-tolerance',
