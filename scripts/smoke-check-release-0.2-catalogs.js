...
assert(mmir.includes('p0-chat-shell.js?v=20260914-calculator-effective-defaults-v1'),'chat must bind the reviewed calculator-effective-defaults shell asset version');
