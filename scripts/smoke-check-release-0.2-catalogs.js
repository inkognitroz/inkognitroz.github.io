...
assert(mmir.includes('p0-chat-shell.js?v=20260914-public-chat-failure-diagnostics-v1'),'chat must bind the reviewed public-failure diagnostic shell asset version');
