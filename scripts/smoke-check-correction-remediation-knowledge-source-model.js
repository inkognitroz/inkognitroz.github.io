...
requireIncludes(files.backlog, '| D243 |', 'Backlog must add D243 after D242.');
...
requireTrue(d243?.status === 'next', 'Progress dashboard task D243 must become next after D242 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D243', 'Progress dashboard next queue must prioritize D243 after D242 ships.');
