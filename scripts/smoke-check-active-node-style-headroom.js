...
requireIncludes(text(files.mmir), 'chat-runtime-deferred.css?v=20260526-stale-offline-model-proof-v1', 'MMIR page must cache-bust deferred runtime CSS for active-node style split.');
