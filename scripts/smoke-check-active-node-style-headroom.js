...
requireIncludes(text(files.mmir), 'chat-runtime-deferred.css?v=20260526-local-model-presence-ready-v1', 'MMIR page must cache-bust deferred runtime CSS for active-node style split.');
