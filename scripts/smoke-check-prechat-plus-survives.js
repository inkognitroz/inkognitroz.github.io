...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d311-20260526-first-impression-local-ready-v1'", 'Service worker cache must rotate for the pre-chat plus fix.');
