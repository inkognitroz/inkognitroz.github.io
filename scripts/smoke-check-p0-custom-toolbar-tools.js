...
requireIncludes(html, 'p0-chat-shell.js?v=20260703-media-picker-v1', 'Public page must cache-bust the toolbar runtime.');
requireIncludes(html, 'p0-chat-shell.css?v=20260703-media-picker-v1', 'Public page must cache-bust the toolbar CSS.');
requireIncludes(html, 'p0-icons.js?v=20260611-lightning-toolbar-icons-v1', 'Public page must cache-bust toolbar icons.');
requireIncludes(manifest, '"p0-chat-shell.js": "20260703-media-picker-v1"', 'Asset manifest must track toolbar runtime version.');
requireIncludes(manifest, '"p0-chat-shell.css": "20260703-media-picker-v1"', 'Asset manifest must track toolbar CSS version.');
