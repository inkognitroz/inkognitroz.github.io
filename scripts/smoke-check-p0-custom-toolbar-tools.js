...
requireIncludes(html, 'p0-chat-shell.js?v=20260613-visible-provider-candidates-v1', 'Public page must cache-bust the toolbar runtime.');
...
requireIncludes(manifest, '"p0-chat-shell.js": "20260613-visible-provider-candidates-v1"', 'Asset manifest must track toolbar runtime version.');
