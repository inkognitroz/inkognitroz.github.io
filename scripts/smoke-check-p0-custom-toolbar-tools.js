...
requireIncludes(html, 'p0-chat-shell.js?v=20260618-interaction-capture-v2', 'Public page must cache-bust the toolbar runtime.');
...
requireIncludes(manifest, '"p0-chat-shell.js": "20260618-interaction-capture-v2"', 'Asset manifest must track toolbar runtime version.');
