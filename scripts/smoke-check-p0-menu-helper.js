...
const shellIndex = html.indexOf('p0-chat-shell.js?v=20260611-custom-toolbar-tools-v1');
...
requireIncludes(assetVersions, '"p0-chat-shell.js": "20260611-custom-toolbar-tools-v1"', 'Asset manifest must track the P0 shell helper slice.');
