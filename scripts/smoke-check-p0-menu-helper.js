...
const shellIndex = html.indexOf('p0-chat-shell.js?v=20260611-b0-06-21-active-local-attach-v1');
...
requireIncludes(assetVersions, '"p0-chat-shell.js": "20260611-b0-06-21-active-local-attach-v1"', 'Asset manifest must track the P0 shell helper slice.');
