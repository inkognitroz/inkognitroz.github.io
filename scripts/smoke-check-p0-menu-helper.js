...
const shellIndex = html.indexOf('p0-chat-shell.js?v=20260613-gateway-compare-pool-v1');
...
requireIncludes(assetVersions, '"p0-chat-shell.js": "20260613-gateway-compare-pool-v1"', 'Asset manifest must track the P0 shell helper slice.');
