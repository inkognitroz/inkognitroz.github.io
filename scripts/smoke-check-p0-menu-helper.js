...
const shellIndex = html.indexOf('p0-chat-shell.js?v=20260607-b0-06-14-route-adapters-v1');
...
requireIncludes(assetVersions, '"p0-chat-shell.js": "20260607-b0-06-14-route-adapters-v1"', 'Asset manifest must track the P0 shell helper slice.');
