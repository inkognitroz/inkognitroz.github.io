...
const shellIndex = html.indexOf('p0-chat-shell.js?v=20260606-b1-06-p0-menu-v1');
...
requireIncludes(assetVersions, '"p0-chat-shell.js": "20260606-b1-06-p0-menu-v1"', 'Asset manifest must track the P0 shell helper slice.');
