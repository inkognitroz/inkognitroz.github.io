...
requireIncludes(files.implementationLog, 'D253 is now next', 'Implementation log must mark D236 next after D235 ships.');
...
requireTrue(d237?.status === 'next', 'Progress dashboard task D253 must become next after D236 ships.');
