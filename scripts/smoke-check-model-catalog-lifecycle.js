...
requireIncludes(sw, "const CACHE_NAME='mmir-pwa-d352-20260714-safe-markdown-v1'", 'Service worker cache name must preserve the model catalog action contract runtime and bust for the safe markdown release.');
