...
requireIncludes(sw, "const CACHE_NAME='mmir-pwa-d354-20260804-release-0-2-beta-v1'", 'Service worker cache name must preserve the model catalog action contract runtime and bust for the 0.2 beta catalog release.');
