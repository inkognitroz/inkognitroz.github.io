...
requireIncludes(sw, "const CACHE_NAME='mmir-pwa-d353-20260714-truthful-chat-state-v1'", 'Service worker cache name must preserve the model catalog action contract runtime and bust for the truthful chat-state release.');
