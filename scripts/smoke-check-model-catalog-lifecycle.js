...
requireIncludes(html, 'model-catalog-ui.js?v=20260710-model-lifecycle-v1', 'Public page must cache-bust model catalog lifecycle JS.');
...
if (manifest.assets?.['model-catalog-ui.js'] !== '20260710-model-lifecycle-v1') {
  failures.push('Asset manifest must track model-catalog-ui.js lifecycle version.');
}
