...
requireIncludes(sw, "const CACHE_NAME='mmir-pwa-d358-20260909-ordinary-chat-v1'", 'Service worker cache name must preserve the reviewed ordinary-chat runtime.');
