...
requireIncludes(sw, "const CACHE_NAME='mmir-pwa-d355-20260804-model-truth-v1'", 'Service worker cache name must preserve the model catalog action contract runtime and bust for shared model truth.');
