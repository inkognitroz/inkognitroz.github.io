...
requireText(join(root, 'scripts', 'smoke-check-first-chat-no-model-dom-fixture.js'), 'First-chat no-model DOM fixture smoke check passed.', 'D209 first-chat no-model DOM fixture must have a dedicated smoke harness.');
...
requireText(join(root, 'scripts', 'smoke-check-composer-action-bar-visual.js'), 'Composer action bar visual smoke check passed.', 'D214 composer action bar visual QA must have a dedicated smoke harness.');
requireText(join(publicDir, 'composer-action-bar-visual-report.json'), 'mobile-composer', 'D214 composer action bar visual report must publish mobile evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D215 |', 'Backlog must keep a next sequential work item after D214.');
requireText(join(root, 'scripts', 'smoke-check-message-action-completeness.js'), 'Message action completeness smoke check passed.', 'D215 message action completeness must have a dedicated smoke harness.');
requireText(join(publicDir, 'message-action-completeness-report.json'), 'share-safe', 'D215 message action completeness report must publish public-safe action evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D216 |', 'Backlog must keep a next sequential work item after D215.');
requireText(join(root, 'scripts', 'smoke-check-message-action-visual.js'), 'Message action visual smoke check passed.', 'D216 message action visual QA must have a dedicated smoke harness.');
requireText(join(publicDir, 'message-action-visual-report.json'), 'mobile-transcript-actions', 'D216 message action visual report must publish mobile transcript evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D217 |', 'Backlog must keep a next sequential work item after D216.');
requireText(join(root, 'scripts', 'smoke-check-message-action-browser-fixture.js'), 'Message action browser fixture smoke check passed.', 'D217 message action browser fixture must have a dedicated smoke harness.');
requireText(join(publicDir, 'message-action-browser-fixture-report.json'), 'safe-share-redaction', 'D217 message action browser fixture report must publish safe-share behavior evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D218 |', 'Backlog must keep a next sequential work item after D217.');
requireText(join(root, 'scripts', 'smoke-check-message-action-accessibility.js'), 'Message action accessibility smoke check passed.', 'D218 message action accessibility must have a dedicated smoke harness.');
requireText(join(publicDir, 'message-action-accessibility-report.json'), 'keyboard-focus', 'D218 message action accessibility report must publish keyboard focus evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D219 |', 'Backlog must keep a next sequential work item after D218.');
...
requireText(join(root, 'scripts', 'smoke-check-promoted-context-next-answer.js'), 'Promoted context next-answer smoke check passed.', 'D221 promoted context next-answer proof must have a dedicated smoke harness.');
requireText(join(publicDir, 'promoted-context-next-answer-report.json'), 'local-memory-injection', 'D221 promoted context report must publish local memory injection evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D222 |', 'Backlog must keep a next sequential work item after D221.');
...
requireText(join(root, 'scripts', 'smoke-check-answer-context-drilldown.js'), 'Answer context drill-down smoke check passed.', 'D224 answer context drill-down must have a dedicated smoke harness.');
requireText(join(publicDir, 'answer-context-drilldown-report.json'), 'memory-drilldown', 'D224 answer context drill-down report must publish memory drill-down evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D225 |', 'Backlog must keep a next sequential work item after D224.');
requireText(join(root, 'scripts', 'smoke-check-answer-context-highlight.js'), 'Answer context highlight smoke check passed.', 'D225 answer context highlight must have a dedicated smoke harness.');
requireText(join(publicDir, 'answer-context-highlight-report.json'), 'highlight-memory', 'D225 answer context highlight report must publish memory highlight evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D226 |', 'Backlog must keep a next sequential work item after D225.');
requireText(join(root, 'scripts', 'smoke-check-answer-context-source-filter.js'), 'Answer context source-filter smoke check passed.', 'D226 answer context source filter must have a dedicated smoke harness.');
requireText(join(publicDir, 'answer-context-source-filter-report.json'), 'memory-use-ids', 'D226 answer context source filter report must publish memory-use ID evidence.');
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D227 |', 'Backlog must keep a next sequential work item after D226.');
requireText(join(root, 'scripts', 'smoke-check-answer-context-filter-consumption.js'), 'Answer context filter consumption smoke check passed.', 'D227 answer context filter consumption must have a dedicated smoke harness.');
requireText(join(publicDir, 'answer-context-filter-consumption-report.json'), 'knowledge-exact-id-explainer', 'D227 answer context filter consumption report must publish knowledge exact-ID gap evidence.');
...
requireText(join(root, 'docs', 'MMIR_SEQUENTIAL_DELIVERY_BACKLOG.md'), '| D232 |', 'Backlog must keep a next sequential work item after D231.');
