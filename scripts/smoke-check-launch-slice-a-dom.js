...
requireIncludes(files.mmir, 'p0-chat-shell.css?v=20260602-voice-route-feedback-v24', 'P0 simple chat shell CSS must load on the public page.');
requireIncludes(files.mmir, 'p0-chat-shell.js?v=20260602-voice-route-feedback-v24', 'P0 simple chat shell runtime must load on the public page.');
