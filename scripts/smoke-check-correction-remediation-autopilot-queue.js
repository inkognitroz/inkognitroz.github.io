...
requireIncludes(files.backlog, '| D246 |', 'Backlog must add D246 after D245.');
...
requireTrue(d246?.status === 'next', 'Progress dashboard task D246 must become next after D245 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D246', 'Progress dashboard next queue must prioritize D246 after D245 ships.');
