...
requireIncludes(files.backlog, '| D245 |', 'Backlog must add D245 after D244.');
...
requireTrue(d245?.status === 'next', 'Progress dashboard task D245 must become next after D244 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D245', 'Progress dashboard next queue must prioritize D245 after D244 ships.');
