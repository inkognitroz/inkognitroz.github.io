...
requireIncludes(html, 'chat-runtime.js?v=20260526-instant-guide-default-v1', 'Chat runtime JS must be cache-busted for early send replay.');
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d318-20260526-instant-guide-default-v1'", 'Service worker cache must rotate for D297 early send replay.');
