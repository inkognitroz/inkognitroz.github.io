...
requireIncludes(text(files.mmir), 'active-node-strip.js?v=20260525-startup-free-llm-nodes-v1', 'MMIR page must cache-bust active-node strip for startup free LLM nodes.');
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d298-20260525-startup-free-llm-nodes-v1'", 'Service worker cache must rotate for D298 startup free LLM nodes.');
