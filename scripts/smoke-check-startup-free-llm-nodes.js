...
requireIncludes(text(files.mmir), 'active-node-strip.js?v=20260526-live-local-chat-start-v1', 'MMIR page must cache-bust active-node strip for startup free LLM nodes.');
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d308-20260526-quick-actions-live-local-v1'", 'Service worker cache must rotate for D298 startup free LLM nodes.');
