...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d310-20260526-local-ready-status-v1'", 'Service worker cache must rotate for D298 startup free LLM nodes.');
