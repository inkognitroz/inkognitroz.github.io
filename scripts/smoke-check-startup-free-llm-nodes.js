...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d314-20260526-local-proof-profile-handoff-v1'", 'Service worker cache must rotate for D298 startup free LLM nodes.');
