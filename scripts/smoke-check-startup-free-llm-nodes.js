...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d301-20260526-live-local-chat-start-v1'", 'Service worker cache must rotate for D298 startup free LLM nodes.');
