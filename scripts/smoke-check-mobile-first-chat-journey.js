...
requireIncludes(mmir, 'chat-workspace.css?v=20260525-toolbar-v2', 'Chat workspace styling must load from the page instead of waiting for runtime patching.');
requireIncludes(mmir, '"./apps/mimir-chat-portal/runtime-controls-fix.js?v=20260525-clean-shell-guard-v1"', 'Runtime control fix must still load progressively with a fresh clean-shell cache key.');
