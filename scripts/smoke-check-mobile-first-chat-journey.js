...
requireIncludes(mmir, 'runtime-controls-fix.js?v=20260524-local-probe-v5', 'Runtime control fix must remain in the critical shell with a fresh mobile cache key.');
