...
requireIncludes(mmir, 'runtime-controls-fix.js?v=20260524-first-chat-p0-v1', 'Runtime control fix must remain in the critical shell with a fresh first-chat cache key.');
