...
requireIncludes(mmir, 'runtime-controls-fix.js?v=20260523-mobile-buttons-v2', 'Runtime control fix must remain in the critical shell with a fresh mobile cache key.');
