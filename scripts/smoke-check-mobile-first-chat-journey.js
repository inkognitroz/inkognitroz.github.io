...
requireIncludes(mmir, 'runtime-controls-fix.js?v=20260525-clean-shell-guard-v1', 'Runtime control fix must remain in the critical shell with a fresh clean-shell cache key.');
