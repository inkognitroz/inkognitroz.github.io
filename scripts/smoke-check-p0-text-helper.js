...
if (api.markdown('**Fet** og `kode`') !== '<p><strong>Fet</strong> og <code>kode</code></p>') fail('markdown must render safe inline emphasis and code.');
if (api.markdown('- en\n- to') !== '<ul><li>en</li><li>to</li></ul>') fail('markdown must render unordered lists.');
