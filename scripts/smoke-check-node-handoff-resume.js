...
requireIncludes(dashboard, "data-node-handoff-tunnel=\"'+safe(tunnelStatus)+'\"", 'Node handoff controls must carry the coarse tunnel state into the saved resume.');
requireIncludes(dashboard, "tunnel_status:control.getAttribute('data-node-handoff-tunnel')||'not_checked'", 'Node handoff action persistence must save the coarse tunnel state.');
