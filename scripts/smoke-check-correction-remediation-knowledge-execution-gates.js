...
requireIncludes(files.backlog, '| D244 |', 'Backlog must add D244 after D243.');
...
requireTrue(d244?.status === 'next', 'Progress dashboard task D244 must become next after D243 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D244', 'Progress dashboard next queue must prioritize D244 after D243 ships.');
