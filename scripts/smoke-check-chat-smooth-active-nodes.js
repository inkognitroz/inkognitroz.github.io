...
requireIncludes(mmir, '<script src="./apps/mimir-chat-portal/active-node-strip.js?v=20260526-local-ready-status-v1" defer></script>', 'MMIR page must load the active chat node strip as critical chat UI.');
