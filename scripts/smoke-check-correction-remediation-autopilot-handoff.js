...
requireIncludes(files.backlog, '| D247 |', 'Backlog must add D247 after D246.');
...
requireTrue(d247?.status === 'next', 'Progress dashboard task D247 must become next after D246 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D247', 'Progress dashboard next queue must prioritize D247 after D246 ships.');
