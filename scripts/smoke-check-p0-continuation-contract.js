...
const expectedCssVersion = assetVersions.assets?.['p0-chat-shell.css'] || '';
if (!expectedShellVersion) failures.push('Asset manifest must track continuation action runtime version.');
if (!expectedCssVersion) failures.push('Asset manifest must track paired P0 CSS version.');
