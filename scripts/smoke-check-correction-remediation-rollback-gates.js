...
requireIncludes(files.backlog, '| D242 |', 'Backlog must add D242 after D241.');
...
requireTrue(d242?.status === 'next', 'Progress dashboard task D242 must become next after D241 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D242', 'Progress dashboard next queue must prioritize D242 after D241 ships.');
