...
requireIncludes(html, 'p0-chat-shell.js?v=20260614-owner-intelligence-ping-v1', 'mmir.html must cache-bust the P0 runtime after WOW demo changes.');
requireIncludes(manifest, '"p0-chat-shell.js": "20260614-owner-intelligence-ping-v1"', 'Asset manifest must track the WOW demo runtime version.');
