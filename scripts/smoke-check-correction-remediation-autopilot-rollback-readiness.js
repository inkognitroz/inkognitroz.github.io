...
requireIncludes(files.backlog, '| D248 |', 'Backlog must add D248 after D247.');
...
requireTrue(d248?.status === 'next', 'Progress dashboard task D248 must become next after D247 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D248', 'Progress dashboard next queue must prioritize D248 after D247 ships.');
