...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d312-20260526-local-model-presence-ready-v1'", 'Service worker cache must rotate for the composer affordance fix.');
