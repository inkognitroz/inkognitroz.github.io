...
for (const needle of [
  ...
  'chat-runtime.js?v=20260525-early-send-replay-v1'
]) {
...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d311-20260526-first-impression-local-ready-v1'", 'Service worker cache must rotate for the composer affordance fix.');
