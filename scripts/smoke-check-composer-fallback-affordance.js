...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d301-20260525-active-node-style-headroom-v1'", 'Service worker cache must rotate for the composer affordance fix.');
