...
for (const needle of [
  ...
  'chat-runtime.js?v=20260526-instant-guide-default-v1'
]) {
...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d318-20260526-instant-guide-default-v1'", 'Service worker cache must rotate for the composer affordance fix.');
