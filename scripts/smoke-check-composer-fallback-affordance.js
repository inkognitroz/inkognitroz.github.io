...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d300-20260525-startup-webgpu-fallback-v1'", 'Service worker cache must rotate for the composer affordance fix.');
