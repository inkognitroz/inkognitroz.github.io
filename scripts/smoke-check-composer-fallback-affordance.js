...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d313-20260526-stale-offline-model-proof-v1'", 'Service worker cache must rotate for the composer affordance fix.');
