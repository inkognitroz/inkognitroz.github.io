...
requireIncludes(text(files.sw), "CACHE_NAME='mmir-pwa-d308-20260526-quick-actions-live-local-v1'", 'Service worker cache must rotate for the composer affordance fix.');
