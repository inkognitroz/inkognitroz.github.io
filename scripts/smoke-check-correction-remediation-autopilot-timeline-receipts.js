...
requireIncludes(files.backlog, '| D251 |', 'Backlog must add D251 after D250.');
...
requireTrue(d251?.status === 'next', 'Progress dashboard task D251 must become next after D250 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D251', 'Progress dashboard next queue must prioritize D251 after D250 ships.');
