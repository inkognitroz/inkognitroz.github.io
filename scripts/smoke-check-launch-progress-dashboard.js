...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d270-20260525-composer-stop-v1', 'Service worker cache must rotate for launch-progress and composer stop assets.');
