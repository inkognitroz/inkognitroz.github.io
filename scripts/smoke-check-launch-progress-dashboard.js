...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d271-20260525-transcript-pin-v1', 'Service worker cache must rotate for launch-progress and transcript pin assets.');
