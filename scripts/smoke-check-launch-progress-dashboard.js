...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d273-20260525-composer-keyboard-v1', 'Service worker cache must rotate for launch-progress and composer keyboard shortcut assets.');
