...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d282-20260525-picker-search-focus-v1', 'Service worker cache must rotate for launch-progress and model picker search-focus assets.');
