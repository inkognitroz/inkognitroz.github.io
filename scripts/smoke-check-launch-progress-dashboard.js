...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d277-20260525-selected-route-v1', 'Service worker cache must rotate for launch-progress and selected-route model picker assets.');
