...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d283-20260525-picker-empty-reset-v1', 'Service worker cache must rotate for launch-progress and model picker empty-reset assets.');
