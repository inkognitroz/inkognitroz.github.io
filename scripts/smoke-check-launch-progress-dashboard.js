...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d280-20260525-picker-filters-v1', 'Service worker cache must rotate for launch-progress and model picker route-filter assets.');
