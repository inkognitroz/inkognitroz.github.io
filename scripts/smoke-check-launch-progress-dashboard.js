...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d281-20260525-picker-reset-v1', 'Service worker cache must rotate for launch-progress and model picker reset assets.');
