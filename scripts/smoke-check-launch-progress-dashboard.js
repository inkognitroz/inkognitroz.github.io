...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d272-20260525-composer-new-chat-v1', 'Service worker cache must rotate for launch-progress and composer new chat assets.');
