...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d274-20260525-composer-autofocus-v1', 'Service worker cache must rotate for launch-progress and composer autofocus assets.');
