...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d268-20260525-chat-focus-v1', 'Service worker cache must rotate for launch-progress and chat-focus assets.');
