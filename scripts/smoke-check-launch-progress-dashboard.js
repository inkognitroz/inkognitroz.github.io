...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d269-20260525-composer-autosize-v1', 'Service worker cache must rotate for launch-progress and composer autosize assets.');
