...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d275-20260525-composer-refocus-v1', 'Service worker cache must rotate for launch-progress and composer refocus assets.');
