...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d276-20260525-proof-compact-v1', 'Service worker cache must rotate for launch-progress and compact proof assets.');
