...
requireIncludes(text(files.serviceWorker), 'mmir-pwa-d311-20260526-first-impression-local-ready-v1', 'Service worker cache must rotate for progress-window and composer-affordance assets.');
