...
requireIncludes(files.starterInstallRepairHarness, 'Starter install repair fallback smoke check passed.', 'D194 starter install repair fallback needs dedicated CI fixture coverage.');
requireIncludes(files.chatRuntime, 'starterInstallRepairFallback', 'D194 chat runtime must turn install failures into repair resume.');
...
requireIncludes(files.starterRetrySuccessHarness, 'Starter retry success closure smoke check passed.', 'D196 starter retry success closure needs dedicated CI fixture coverage.');
requireIncludes(files.chatRuntime, 'closeStarterRetrySuccess', 'D196 chat runtime must close repair ambiguity after starter retry success.');
...
requireIncludes(files.firstFreeChatResponseHarness, 'First free chat response QA smoke check passed.', 'D212 first free chat response QA must have dedicated CI coverage.');
requireIncludes(files.firstFreeChatResponseReport, 'Primary next action', 'D212 first free chat response report must expose one next action.');
requireIncludes(files.progressDashboard, 'renderFirstFreeChatResponseReport', 'D212 Progress Dashboard must render first free chat response evidence.');
...
requireIncludes(files.messageActionVisualHarness, 'Message action visual smoke check passed.', 'D216 message action visual QA must have dedicated CI coverage.');
requireIncludes(files.messageActionVisualReport, 'mobile-transcript-actions', 'D216 message action visual report must cover mobile transcript behavior.');
requireIncludes(files.progressDashboard, 'renderMessageActionVisualReport', 'D216 Progress Dashboard must render message action visual evidence.');
