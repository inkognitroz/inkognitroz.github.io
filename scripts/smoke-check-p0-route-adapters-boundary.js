...
requireIncludes(html, 'p0-chat-shell.js?v=20260625-compact-models-v2', 'mmir.html must cache-bust the P0 shell for the adapter-boundary slice.');
...
requireIncludes(manifest, '"p0-chat-shell.js": "20260625-compact-models-v2"', 'Asset manifest must track the P0 shell adapter-boundary version.');
