...
requireIncludes(helper, "version='20260909-calculator-attribution-v1'", 'P0 route adapter helper version must be explicit.');
...
if (!api || api.version !== '20260909-calculator-attribution-v1') fail('P0 route adapter helper must register on window.');
