...
requireIncludes(html, 'p0-chat-shell.js?v=20260618-swarm-scorecard-v1', 'mmir.html must cache-bust the P0 shell for the adapter-boundary slice.');
...
requireIncludes(manifest, '"p0-chat-shell.js": "20260618-swarm-scorecard-v1"', 'Asset manifest must track the P0 shell adapter-boundary version.');
