...
requireIncludes(helper, "version='20260921-backend-session-v1'", 'P0 route adapter helper version must be explicit.');
...
if (!api || api.version !== '20260921-backend-session-v1') fail('P0 route adapter helper must register on window.');
