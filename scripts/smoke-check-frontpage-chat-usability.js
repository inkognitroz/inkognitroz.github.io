...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d313-20260526-stale-offline-model-proof-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
