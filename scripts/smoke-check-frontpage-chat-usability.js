...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d300-20260525-startup-webgpu-fallback-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
