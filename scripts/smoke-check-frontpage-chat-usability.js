...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d310-20260526-local-ready-status-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
