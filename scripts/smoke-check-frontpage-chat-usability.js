...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d301-20260525-active-node-style-headroom-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
