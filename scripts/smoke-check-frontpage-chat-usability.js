...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d295-20260525-prechat-plus-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
