...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d301-20260526-live-local-chat-start-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
