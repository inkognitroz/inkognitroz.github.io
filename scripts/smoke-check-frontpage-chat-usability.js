...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d296-20260525-runtime-css-headroom-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
