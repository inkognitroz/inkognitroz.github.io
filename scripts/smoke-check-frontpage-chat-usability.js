...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d308-20260526-quick-actions-live-local-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
