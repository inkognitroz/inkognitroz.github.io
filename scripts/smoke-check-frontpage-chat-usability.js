...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d297-20260525-early-send-replay-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
