...
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d298-20260525-startup-free-llm-nodes-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
