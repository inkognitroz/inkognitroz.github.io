...
requireIncludes(html, 'composer-model-picker.css?v=20260526-picker-live-local-v1', 'Composer model picker CSS must be cache-busted for picker empty-reset polish.');
requireIncludes(html, 'composer-model-picker.js?v=20260526-picker-live-local-v1', 'Composer model picker JS must be cache-busted for picker empty-reset polish.');
requireIncludes(sw, "CACHE_NAME='mmir-pwa-d309-20260526-picker-live-local-v1'", 'Service worker cache must be bumped for the latest chat shell and composer affordance fixes.');
