...
requireIncludes(files.backlog, '| D240 |', 'Backlog must add D240 after D239.');
...
requireTrue(d240?.status === 'next', 'Progress dashboard task D240 must become next after D239 ships.');
requireTrue(Array.isArray(progress.next_queue) && progress.next_queue[0] === 'D240', 'Progress dashboard next queue must prioritize D240 after D239 ships.');
