...
if (!html.includes('composer-model-picker.css?v=20260525-picker-reset-v1')) {
  fail('MMIR page must cache-bust the model picker reset CSS.');
}

if (!sw.includes("CACHE_NAME='mmir-pwa-d281-20260525-picker-reset-v1'")) {
