...
if (!html.includes('composer-model-picker.css?v=20260525-picker-close-v1')) {
  fail('MMIR page must cache-bust the model picker close-flow CSS.');
}

if (!sw.includes("CACHE_NAME='mmir-pwa-d278-20260525-picker-close-v1'")) {
