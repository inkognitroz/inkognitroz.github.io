...
if (!html.includes('composer-model-picker.css?v=20260525-picker-search-v1')) {
  fail('MMIR page must cache-bust the model picker search CSS.');
}

if (!sw.includes("CACHE_NAME='mmir-pwa-d279-20260525-picker-search-v1'")) {
