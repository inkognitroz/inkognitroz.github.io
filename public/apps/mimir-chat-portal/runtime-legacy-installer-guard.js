...
function rewriteLegacyInstallerUi(){
  ...
  r.innerHTML='<a href="./downloads/mmir-local-connector-install.html#terminal-install">Mac Terminal install</a><a href="./downloads/mmir-local-connector-windows.cmd" download>Win</a><a href="./downloads/mmir-local-connector-linux.sh" download>Linux</a>';
