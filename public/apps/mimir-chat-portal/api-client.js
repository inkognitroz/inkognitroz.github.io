(function(){
  ...
  function personalMemoryScope(path,method){
    ...
    const documentList=/^\/knowledge\/documents\?workspace_id=[^/?#&]+$/.test(normalized);
    ...
    return (method==='GET'&&(normalized==='/consent'||normalized==='/memory'||item||documentList||missionList||mission))||
