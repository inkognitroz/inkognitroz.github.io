(function(){
  ...
  const P0_RUNTIME_VERSION='20260625-route-cta-separator-v1';
  ...
  function renderMicroStatus(el,message,stateValue='hosted'){
    ...
    const actionSeparator=action?'<span class="p0-route-action-separator" aria-hidden="true"> · </span>':'';
    el.dataset.hasRouteAction=action?'true':'false';
    el.innerHTML='<span class="p0-route-line">'+safeText(visible)+'</span>'+actionSeparator+action;
  }
