(function(){
  ...
  function feedbackFooter(best,freshness){
    ...
    return '<div class="mmir-active-node-overflow" data-route-feedback-state="'+safe(freshness.state)+'"><p>Capture route friction from this exact surface so owner triage keeps the live demo path honest.</p><button type="button" data-active-route-feedback>'+safe('Report route issue')+'</button></div>';
  }
