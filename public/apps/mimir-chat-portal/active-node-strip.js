(function(){
  ...
  function normalizeStarter(model){
    ...
    return {...model,label:FALLBACK_LABEL,best_for:'Instant first answer while MMIR upgrades to a verified browser, API or local model route.',install_note:'No install required. Supergenius Free answers immediately. MMIR automatically upgrades to WebGPU, api.mmir.ai or Local Node when available.'};
  }
  ...
  function activateNode(node){
    ...
    selectStarter(node,'Start Supergenius Free instant chat.');
  }
