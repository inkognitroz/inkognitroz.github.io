...
MMIR_SITE="${MMIR_SITE:-https://mmir.ai/mmir.html?mmir_local_return=1#local-connector}"
SERVER_SOURCE="${MMIR_LOCAL_CONNECTOR_SERVER_SOURCE:-https://mmir.ai/downloads/mmir-local-connector-server.mjs}"
SERVER_SHA256="${MMIR_LOCAL_CONNECTOR_SERVER_SHA256:-1fca82c96fdbff3511da3cb71662a2fc8611aae011b20439215660c58813f351}"
